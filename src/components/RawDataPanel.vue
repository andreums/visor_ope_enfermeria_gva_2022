...
<template>
  <div class="p-4 bg-white rounded-lg shadow-md relative">
    ...
    >
      ...
      <Column field="vacancies_offered" header="Plazas ofertadas" filter sortable />
      <Column field="vacancies_assigned" header="Plazas asignadas" filter sortable />
      <Column field="vacancies_difference" header="Diferencia de plazas" filter sortable />
    </DataTable>
  </div>
</template>