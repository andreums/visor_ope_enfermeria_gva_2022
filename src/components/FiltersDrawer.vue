...
<template>
  <div v-if="modelValueShow" class="p-6 bg-white rounded-lg shadow-md flex flex-col gap-4">
    ...
    <div class="flex items-center mt-4 gap-3">
      ...
      <InputSwitch
        :model-value="modelValueShowEmpty"
        @update:modelValue="value => $emit('update:modelValueShowEmpty', value)"
        class="rounded-full bg-blue-50 focus:ring-blue-400 focus:border-blue-400"
      />
    </div>
  </div>
</template>
