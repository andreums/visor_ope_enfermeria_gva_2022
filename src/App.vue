...
import usePlazas from '@/composables/usePlazas'
      ...
      <div class="h-[calc(100dvh-4rem)] w-full relative">
        ...
        <transition name="drawer">
          ...
          >
            <FiltersDrawer
              ...
              :model-value-show-empty="showEmpty"
              ...
              @update:model-value-show-empty="setShowEmpty"
        ...
        <div class="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex gap-4">
          <button
            ...
            class="flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-full shadow-lg hover:bg-blue-700 transition"
